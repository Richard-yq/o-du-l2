...
typedef enum CSI_ReportConfig__nrofCQIsPerReport {
	CSI_ReportConfig__nrofCQIsPerReport_n1	= 0,
	CSI_ReportConfig__nrofCQIsPerReport_n2	= 1
} e_CSI_ReportConfig__nrofCQIsPerReport;
...
typedef struct CSI_ReportConfig {
	...
	long	*nrofCQIsPerReport;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_nrofCQIsPerReport_76;	// (Use -fall-defs-global to expose) */
