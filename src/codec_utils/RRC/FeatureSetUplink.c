...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_simultaneousTxSUL_NonSUL_v1530_constr_19 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_simultaneousTxSUL_NonSUL_v1530_value2enum_19[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_simultaneousTxSUL_NonSUL_v1530_enum2value_19[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_simultaneousTxSUL_NonSUL_v1530_specs_19 = {
	asn_MAP_simultaneousTxSUL_NonSUL_v1530_value2enum_19,	/* "tag" => N; sorted by tag */
	asn_MAP_simultaneousTxSUL_NonSUL_v1530_enum2value_19,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_simultaneousTxSUL_NonSUL_v1530_tags_19[] = {
	(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_simultaneousTxSUL_NonSUL_v1530_19 = {
	"simultaneousTxSUL-NonSUL-v1530",
	"simultaneousTxSUL-NonSUL-v1530",
	&asn_OP_NativeEnumerated,
	asn_DEF_simultaneousTxSUL_NonSUL_v1530_tags_19,
	sizeof(asn_DEF_simultaneousTxSUL_NonSUL_v1530_tags_19)
		/sizeof(asn_DEF_simultaneousTxSUL_NonSUL_v1530_tags_19[0]) - 1, /* 1 */
	asn_DEF_simultaneousTxSUL_NonSUL_v1530_tags_19,	/* Same as above */
	sizeof(asn_DEF_simultaneousTxSUL_NonSUL_v1530_tags_19)
		/sizeof(asn_DEF_simultaneousTxSUL_NonSUL_v1530_tags_19[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_simultaneousTxSUL_NonSUL_v1530_constr_19,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_simultaneousTxSUL_NonSUL_v1530_specs_19	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_FeatureSetUplink_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct FeatureSetUplink, simultaneousTxSUL_NonSUL_v1530),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_simultaneousTxSUL_NonSUL_v1530_19,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_FeatureSetUplink_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* simultaneousTxSUL-NonSUL-v1530 */
