...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_nrofCQIsPerReport_constr_76 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_nrofCQIsPerReport_value2enum_76[] = {
	{ 0,	2,	"n1" },
	{ 1,	2,	"n2" }
};
static const unsigned int asn_MAP_nrofCQIsPerReport_enum2value_76[] = {
	0,	/* n1(0) */
	1	/* n2(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_nrofCQIsPerReport_specs_76 = {
	asn_MAP_nrofCQIsPerReport_value2enum_76,	/* "tag" => N; sorted by tag */
	asn_MAP_nrofCQIsPerReport_enum2value_76,	/* N => "tag"; sorted by N */
	2,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_nrofCQIsPerReport_tags_76[] = {
	(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_nrofCQIsPerReport_76 = {
	"nrofCQIsPerReport",
	"nrofCQIsPerReport",
	&asn_OP_NativeEnumerated,
	asn_DEF_nrofCQIsPerReport_tags_76,
	sizeof(asn_DEF_nrofCQIsPerReport_tags_76)
		/sizeof(asn_DEF_nrofCQIsPerReport_tags_76[0]) - 1, /* 1 */
	asn_DEF_nrofCQIsPerReport_tags_76,	/* Same as above */
	sizeof(asn_DEF_nrofCQIsPerReport_tags_76)
		/sizeof(asn_DEF_nrofCQIsPerReport_tags_76[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_nrofCQIsPerReport_constr_76,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_nrofCQIsPerReport_specs_76	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_CSI_ReportConfig_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CSI_ReportConfig, nrofCQIsPerReport),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_nrofCQIsPerReport_76,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_CSI_ReportConfig_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 11, 0, 0 }, /* nrofCQIsPerReport */
