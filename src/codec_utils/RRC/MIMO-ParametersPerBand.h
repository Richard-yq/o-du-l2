...
typedef enum MIMO_ParametersPerBand__pusch_TransCoherence {
	...
	MIMO_ParametersPerBand__pusch_TransCoherence_partialNonCoherent	= 1,
...
/* extern asn_TYPE_descriptor_t asn_DEF_scs_60kHz_85;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_scs_120kHz_89;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_aperiodicTRS_104;	// (Use -fall-defs-global to expose) */
