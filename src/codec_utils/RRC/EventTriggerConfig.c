...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_maxNrofRSIndexesToReport_constr_53 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_EventTriggerConfig_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct EventTriggerConfig, reportQuantityRsIndexes),
	...
	{ ATF_POINTER, 1, offsetof(struct EventTriggerConfig, maxNrofRSIndexesToReport),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_maxNrofRSIndexesToReport_constr_53,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const asn_TYPE_tag2member_t asn_MAP_EventTriggerConfig_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* reportQuantityRsIndexes */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* maxNrofRSIndexesToReport */
