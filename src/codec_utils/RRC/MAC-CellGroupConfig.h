...
struct SetupRelease_DRX_ConfigRrc;
...
typedef struct MAC_CellGroupConfig {
	struct SetupRelease_DRX_ConfigRrc	*drx_Config;	/* OPTIONAL */
	...
	struct MAC_CellGroupConfig__ext1 {
		...
		struct SetupRelease_DataInactivityTimer	*dataInactivityTimer_v1530;	/* OPTIONAL */
