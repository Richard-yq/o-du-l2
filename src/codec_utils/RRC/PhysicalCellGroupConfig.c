...
asn_TYPE_member_t asn_MBR_PhysicalCellGroupConfig_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct PhysicalCellGroupConfig, tpc_SRS_RNTI),
	...
	{ ATF_POINTER, 5, offsetof(struct PhysicalCellGroupConfig, tpc_PUCCH_RNTI),
	...
	{ ATF_POINTER, 4, offsetof(struct PhysicalCellGroupConfig, tpc_PUSCH_RNTI),
	...
	{ ATF_POINTER, 3, offsetof(struct PhysicalCellGroupConfig, sp_CSI_RNTI),
	...
	{ ATF_POINTER, 2, offsetof(struct PhysicalCellGroupConfig, cs_RNTI),
	...
	{ ATF_POINTER, 1, offsetof(struct PhysicalCellGroupConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext1_16,
		0,
...
static const int asn_MAP_PhysicalCellGroupConfig_oms_1[] = { 0, 1, 2, 4, 5, 6, 7, 8, 9 };
