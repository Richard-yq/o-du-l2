...
static asn_per_constraints_t asn_PER_type_cnType_r15_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_cnType_r15_value2enum_3[] = {
	{ 0,	3,	"epc" },
	{ 1,	6,	"fiveGC" }
};
static const unsigned int asn_MAP_cnType_r15_enum2value_3[] = {
	0,	/* epc(0) */
	1	/* fiveGC(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_cnType_r15_specs_3 = {
	asn_MAP_cnType_r15_value2enum_3,	/* "tag" => N; sorted by tag */
	asn_MAP_cnType_r15_enum2value_3,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_cnType_r15_tags_3[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_cnType_r15_3 = {
	"cnType-r15",
	"cnType-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_cnType_r15_tags_3,
	sizeof(asn_DEF_cnType_r15_tags_3)
		/sizeof(asn_DEF_cnType_r15_tags_3[0]) - 1, /* 1 */
	asn_DEF_cnType_r15_tags_3,	/* Same as above */
	sizeof(asn_DEF_cnType_r15_tags_3)
		/sizeof(asn_DEF_cnType_r15_tags_3[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_cnType_r15_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
	...
	&asn_SPC_cnType_r15_specs_3	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RedirectedCarrierInfo_EUTRA_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RedirectedCarrierInfo_EUTRA, cnType_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_cnType_r15_3,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_RedirectedCarrierInfo_EUTRA_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cnType-r15 */
};
