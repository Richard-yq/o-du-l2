...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_pdcp_DuplicationSRB3_constr_38 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_pdcp_DuplicationMCG_OrSCG_constr_40 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_pdcp_DuplicationSRB3_value2enum_38[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_pdcp_DuplicationSRB3_enum2value_38[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_pdcp_DuplicationSRB3_specs_38 = {
	asn_MAP_pdcp_DuplicationSRB3_value2enum_38,	/* "tag" => N; sorted by tag */
	asn_MAP_pdcp_DuplicationSRB3_enum2value_38,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_pdcp_DuplicationSRB3_tags_38[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_pdcp_DuplicationSRB3_38 = {
	"pdcp-DuplicationSRB3",
	"pdcp-DuplicationSRB3",
	&asn_OP_NativeEnumerated,
	asn_DEF_pdcp_DuplicationSRB3_tags_38,
	sizeof(asn_DEF_pdcp_DuplicationSRB3_tags_38)
		/sizeof(asn_DEF_pdcp_DuplicationSRB3_tags_38[0]) - 1, /* 1 */
	asn_DEF_pdcp_DuplicationSRB3_tags_38,	/* Same as above */
	sizeof(asn_DEF_pdcp_DuplicationSRB3_tags_38)
		/sizeof(asn_DEF_pdcp_DuplicationSRB3_tags_38[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_pdcp_DuplicationSRB3_constr_38,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_pdcp_DuplicationSRB3_specs_38	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_pdcp_DuplicationMCG_OrSCG_value2enum_40[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_pdcp_DuplicationMCG_OrSCG_enum2value_40[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_pdcp_DuplicationMCG_OrSCG_specs_40 = {
	asn_MAP_pdcp_DuplicationMCG_OrSCG_value2enum_40,	/* "tag" => N; sorted by tag */
	asn_MAP_pdcp_DuplicationMCG_OrSCG_enum2value_40,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_pdcp_DuplicationMCG_OrSCG_tags_40[] = {
	(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_pdcp_DuplicationMCG_OrSCG_40 = {
	"pdcp-DuplicationMCG-OrSCG",
	"pdcp-DuplicationMCG-OrSCG",
	&asn_OP_NativeEnumerated,
	asn_DEF_pdcp_DuplicationMCG_OrSCG_tags_40,
	sizeof(asn_DEF_pdcp_DuplicationMCG_OrSCG_tags_40)
		/sizeof(asn_DEF_pdcp_DuplicationMCG_OrSCG_tags_40[0]) - 1, /* 1 */
	asn_DEF_pdcp_DuplicationMCG_OrSCG_tags_40,	/* Same as above */
	sizeof(asn_DEF_pdcp_DuplicationMCG_OrSCG_tags_40)
		/sizeof(asn_DEF_pdcp_DuplicationMCG_OrSCG_tags_40[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_pdcp_DuplicationMCG_OrSCG_constr_40,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_pdcp_DuplicationMCG_OrSCG_specs_40	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_PDCP_Parameters_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct PDCP_Parameters, pdcp_DuplicationSRB3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_pdcp_DuplicationSRB3_38,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct PDCP_Parameters, pdcp_DuplicationMCG_OrSCG),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_pdcp_DuplicationMCG_OrSCG_40,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_PDCP_Parameters_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* pdcp-DuplicationSRB3 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* pdcp-DuplicationMCG-OrSCG */
};
