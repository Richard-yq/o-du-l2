...
static int
memb_maxNrofRsIndexesToReport_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_maxNrofRsIndexesToReport_constr_16 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_PeriodicalReportConfig_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct PeriodicalReportConfig, reportQuantityRsIndexes),
	...
	{ ATF_POINTER, 1, offsetof(struct PeriodicalReportConfig, maxNrofRsIndexesToReport),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_maxNrofRsIndexesToReport_constr_16,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_maxNrofRsIndexesToReport_constraint_1
		},
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_PeriodicalReportConfig_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* reportQuantityRsIndexes */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* maxNrofRsIndexesToReport */
