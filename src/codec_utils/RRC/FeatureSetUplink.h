...
typedef enum FeatureSetUplink__simultaneousTxSUL_NonSUL_v1530 {
	FeatureSetUplink__simultaneousTxSUL_NonSUL_v1530_supported	= 0
} e_FeatureSetUplink__simultaneousTxSUL_NonSUL_v1530;
...
typedef struct FeatureSetUplink {
	...
	long	*simultaneousTxSUL_NonSUL_v1530;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_simultaneousTxSUL_NonSUL_v1530_19;	// (Use -fall-defs-global to expose) */
