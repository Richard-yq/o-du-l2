...
typedef enum Phy_ParametersFR1__pdsch_RE_MappingFR1 {
	Phy_ParametersFR1__pdsch_RE_MappingFR1_n10	= 0,
	Phy_ParametersFR1__pdsch_RE_MappingFR1_n20	= 1
} e_Phy_ParametersFR1__pdsch_RE_MappingFR1;
...
typedef struct Phy_ParametersFR1 {
	...
	long	*pdsch_RE_MappingFR1;	/* OPTIONAL */
	/*
...
/* extern asn_TYPE_descriptor_t asn_DEF_pdsch_RE_MappingFR1_8;	// (Use -fall-defs-global to expose) */
