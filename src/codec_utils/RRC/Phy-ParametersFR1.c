...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_pdsch_RE_MappingFR1_constr_8 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_pdsch_RE_MappingFR1_value2enum_8[] = {
	{ 0,	3,	"n10" },
	{ 1,	3,	"n20" }
};
static const unsigned int asn_MAP_pdsch_RE_MappingFR1_enum2value_8[] = {
	0,	/* n10(0) */
	1	/* n20(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_pdsch_RE_MappingFR1_specs_8 = {
	asn_MAP_pdsch_RE_MappingFR1_value2enum_8,	/* "tag" => N; sorted by tag */
	asn_MAP_pdsch_RE_MappingFR1_enum2value_8,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_pdsch_RE_MappingFR1_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_pdsch_RE_MappingFR1_8 = {
	"pdsch-RE-MappingFR1",
	"pdsch-RE-MappingFR1",
	&asn_OP_NativeEnumerated,
	asn_DEF_pdsch_RE_MappingFR1_tags_8,
	sizeof(asn_DEF_pdsch_RE_MappingFR1_tags_8)
		/sizeof(asn_DEF_pdsch_RE_MappingFR1_tags_8[0]) - 1, /* 1 */
	asn_DEF_pdsch_RE_MappingFR1_tags_8,	/* Same as above */
	sizeof(asn_DEF_pdsch_RE_MappingFR1_tags_8)
		/sizeof(asn_DEF_pdsch_RE_MappingFR1_tags_8[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_pdsch_RE_MappingFR1_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_pdsch_RE_MappingFR1_specs_8	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_Phy_ParametersFR1_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersFR1, pdsch_RE_MappingFR1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_pdsch_RE_MappingFR1_8,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_Phy_ParametersFR1_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* pdsch-RE-MappingFR1 */
};
