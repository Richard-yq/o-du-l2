...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_maxUplinkDutyCycle_constr_47 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_maxUplinkDutyCycle_value2enum_47[] = {
	{ 0,	3,	"n60" },
	{ 1,	3,	"n70" },
	{ 2,	3,	"n80" },
	{ 3,	3,	"n90" },
...
static const unsigned int asn_MAP_maxUplinkDutyCycle_enum2value_47[] = {
	4,	/* n100(4) */
	0,	/* n60(0) */
	1,	/* n70(1) */
	2,	/* n80(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_maxUplinkDutyCycle_specs_47 = {
	asn_MAP_maxUplinkDutyCycle_value2enum_47,	/* "tag" => N; sorted by tag */
	asn_MAP_maxUplinkDutyCycle_enum2value_47,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_maxUplinkDutyCycle_tags_47[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_maxUplinkDutyCycle_47 = {
	"maxUplinkDutyCycle",
	"maxUplinkDutyCycle",
	&asn_OP_NativeEnumerated,
	asn_DEF_maxUplinkDutyCycle_tags_47,
	sizeof(asn_DEF_maxUplinkDutyCycle_tags_47)
		/sizeof(asn_DEF_maxUplinkDutyCycle_tags_47[0]) - 1, /* 1 */
	asn_DEF_maxUplinkDutyCycle_tags_47,	/* Same as above */
	sizeof(asn_DEF_maxUplinkDutyCycle_tags_47)
		/sizeof(asn_DEF_maxUplinkDutyCycle_tags_47[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_maxUplinkDutyCycle_constr_47,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_maxUplinkDutyCycle_specs_47	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_46[] = {
	{ ATF_POINTER, 1, offsetof(struct BandNR__ext1, maxUplinkDutyCycle),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_maxUplinkDutyCycle_47,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_46[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* maxUplinkDutyCycle */
};
