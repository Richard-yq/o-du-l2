...
typedef enum CellsTriggeredList__Member__physCellIdEUTRA {
	CellsTriggeredList__Member__physCellIdEUTRA_ffsTypeAndValue	= 0
} e_CellsTriggeredList__Member__physCellIdEUTRA;
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_physCellIdEUTRA_4;	// (Use -fall-defs-global to expose) */
