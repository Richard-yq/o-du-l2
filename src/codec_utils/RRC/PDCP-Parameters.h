...
typedef enum PDCP_Parameters__pdcp_DuplicationSRB3 {
	PDCP_Parameters__pdcp_DuplicationSRB3_supported	= 0
} e_PDCP_Parameters__pdcp_DuplicationSRB3;
typedef enum PDCP_Parameters__pdcp_DuplicationMCG_OrSCG {
	PDCP_Parameters__pdcp_DuplicationMCG_OrSCG_supported	= 0
} e_PDCP_Parameters__pdcp_DuplicationMCG_OrSCG;
...
typedef struct PDCP_Parameters {
	...
	long	*pdcp_DuplicationSRB3;	/* OPTIONAL */
	long	*pdcp_DuplicationMCG_OrSCG;	/* OPTIONAL */
	/*
...
/* extern asn_TYPE_descriptor_t asn_DEF_pdcp_DuplicationSRB3_38;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_pdcp_DuplicationMCG_OrSCG_40;	// (Use -fall-defs-global to expose) */
