...
typedef enum FeatureSetDownlink__timeDurationForQCL__sch_120kHz {
	FeatureSetDownlink__timeDurationForQCL__sch_120kHz_s14	= 0,
	FeatureSetDownlink__timeDurationForQCL__sch_120kHz_s28	= 1
} e_FeatureSetDownlink__timeDurationForQCL__sch_120kHz;
typedef enum FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_15kHz {
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_15kHz_upto2	= 0,
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_15kHz_upto4	= 1,
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_15kHz_upto7	= 2
} e_FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_15kHz;
typedef enum FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_30kHz {
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_30kHz_upto2	= 0,
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_30kHz_upto4	= 1,
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_30kHz_upto7	= 2
} e_FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_30kHz;
typedef enum FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_60kHz {
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_60kHz_upto2	= 0,
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_60kHz_upto4	= 1,
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_60kHz_upto7	= 2
} e_FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_60kHz;
typedef enum FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_120kHz {
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_120kHz_upto2	= 0,
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_120kHz_upto4	= 1,
	FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_120kHz_upto7	= 2
} e_FeatureSetDownlink__pdsch_DifferentTB_PerSlot__scs_120kHz;
...
typedef struct FeatureSetDownlink {
	...
	struct FeatureSetDownlink__timeDurationForQCL {
		...
		long	*sch_120kHz;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *timeDurationForQCL;
	struct FeatureSetDownlink__pdsch_DifferentTB_PerSlot {
...
/* extern asn_TYPE_descriptor_t asn_DEF_sch_120kHz_33;	// (Use -fall-defs-global to expose) */
