 ...
 */
static int
memb_modifiedMRP_BehaviorEUTRA_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_modifiedMRP_BehaviorEUTRA_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
asn_TYPE_member_t asn_MBR_EUTRA_ParametersCommon_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_ParametersCommon, modifiedMRP_BehaviorEUTRA),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_modifiedMRP_BehaviorEUTRA_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_modifiedMRP_BehaviorEUTRA_constraint_1
		},
		0, 0, /* No default value */
		"modifiedMRP-BehaviorEUTRA"
		},
...
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_ParametersCommon_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* modifiedMRP-BehaviorEUTRA */
