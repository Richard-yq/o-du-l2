...
typedef enum BandNR__ext1__maxUplinkDutyCycle {
	BandNR__ext1__maxUplinkDutyCycle_n60	= 0,
	BandNR__ext1__maxUplinkDutyCycle_n70	= 1,
	BandNR__ext1__maxUplinkDutyCycle_n80	= 2,
	BandNR__ext1__maxUplinkDutyCycle_n90	= 3,
	BandNR__ext1__maxUplinkDutyCycle_n100	= 4
} e_BandNR__ext1__maxUplinkDutyCycle;
...
typedef struct BandNR {
	 ...
	 */
	struct BandNR__ext1 {
		long	*maxUplinkDutyCycle;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_maxUplinkDutyCycle_47;	// (Use -fall-defs-global to expose) */
